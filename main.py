...
class TrainingData(Sequence):
	def __init__(self, score, steps=1000, batch_size=16):
		"""
...
if isfile('./models/standard_epoch210.model'):
	tmp = keras.models.load_model('./models/standard_epoch210.model')
	model.set_weights(tmp.get_weights())
	print('Load model 210 success!')
else:
	log = open('model_log.txt', "a")
...
prepare_submission(0.99, './submission_epoch210.csv')
